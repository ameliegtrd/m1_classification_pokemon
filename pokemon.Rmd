...
# on regarde le nombre de pokemeon "doublons" (numero de pokedex)
sum(duplicated(pokemon[,"pokedex_number"])) # 147 doublons
# on enleve les doublons
pokemon2 <- pokemon %>% distinct(pokedex_number, .keep_all = TRUE) # eneleve les Mega et garde uniquement les formes de bases des pokemon (pas les evolutions)
