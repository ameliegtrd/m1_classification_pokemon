...
load_lib <- c("tidyverse", "kableExtra", "FactoMineR", "factoextra")
...
On considère maintenant tous les pokémons (type 1 et 2). Pour cela, on regroupe les colonnes "type_1" et "type_2" en une seule, intitulée "type". On a donc ... type possible pour chaque pokémon. 
```{r}
